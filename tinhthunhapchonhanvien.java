...
class personnel{
    ...
    int setPhuCap(){
        chucVu = chucVu + "xxxxxxx";
        if(chucVu.substring(0,2).compareTo("GD") == 0) return 500;
        else if(chucVu.substring(0,3).compareTo("PGD") == 0) return 400;
        else if(chucVu.substring(0,2).compareTo("TP") == 0) return 300;
        else if(chucVu.substring(0,2).compareTo("KT") == 0) return 250;
        else return 100;
    }
    int setTamUng(){
